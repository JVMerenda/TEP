...
GRAPH_TYPES=("erdos-renyi" "regular" "barabasi-albert" "scale-free" "watts-strogatz" "euclidean" "grid" "geometric" "erdos-renyi-multi-degree" "regular-multi-degree" "barabasi-albert-multi-degree" "scale-free-multi-degree" "watts-strogatz-multi-degree" "euclidean-multi-degree" "grid-multi-degree" "geometric-multi-degree") # real, since they are handled differently, geometric acted up, and has to be handled later
