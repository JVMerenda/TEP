...
parameter_combinations = [
    ...
    (N=200, D=Exponential(0.134), p=0.0),
    (N=250, D=Exponential(0.119), p=0.0),
    (N=300, D=Exponential(0.108), p=0.0),
    (N=400, D=Exponential(0.093), p=0.0),
    (N=500, D=Exponential(0.083), p=0.0),
    (N=600, D=Exponential(0.076), p=0.0),
    (N=700, D=Exponential(0.070), p=0.0),
    (N=750, D=Exponential(0.067), p=0.0),
    (N=800, D=Exponential(0.065), p=0.0),
    (N=900, D=Exponential(0.061), p=0.0),
