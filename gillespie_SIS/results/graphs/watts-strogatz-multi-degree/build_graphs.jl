...
parameter_combinations = [
    ...
    (N=200, k=k_distribution, p=.1),
    (N=250, k=k_distribution, p=.1),
    (N=300, k=k_distribution, p=.1),
    (N=400, k=k_distribution, p=.1),
    (N=500, k=k_distribution, p=.1),
    (N=600, k=k_distribution, p=.1),
    (N=700, k=k_distribution, p=.1),
    (N=750, k=k_distribution, p=.1),
    (N=800, k=k_distribution, p=.1),
    (N=900, k=k_distribution, p=.1),
